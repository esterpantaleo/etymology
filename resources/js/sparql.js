var SPARQL = (function(module) {
    ...
    module.searchSparql = function(word) {
    ...
    module.ancestorSparql = function(id, parameter) {
        var query;
        if (parameter === 1) {
            query = [
                "PREFIX dbetym: <http://etytree-virtuoso.wmflabs.org/dbnaryetymology#> ",
    ...
    module.descendantSparql = function(id) {
        var query = [
    ...
    module.unionSparql = function(id_arr, sparql) {
        var query = [
            "PREFIX dbetym: <http://etytree-virtuoso.wmflabs.org/dbnaryetymology#>",
            "SELECT * WHERE {{"
        ];
