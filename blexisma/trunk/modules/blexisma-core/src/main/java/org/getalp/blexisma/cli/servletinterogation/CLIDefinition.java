...
public class CLIDefinition {
	...
	public static void main(String[] args) throws InterruptedException {
			if (args.length!=2) {
				System.err.println("Usage: java ... " + CLIDefinition.class.getName() + " language applet_url (optional regex)");
				System.exit(-1);
			}
			...
			request = ServletFormatManager.defFormat(analyse.toString(), lg);
