...
/** 
* @property {Number} ANCESTORS_DEPTH - depth of ancestorQuery
*
*/
const ANCESTORS_DEPTH = 5,
...
module.exports = {
    ...
    postXMLHttpRequest:  postXMLHttpRequest,
    postMoreAncestorsQuery: postMoreAncestorsQuery,
    disambiguationQuery: disambiguationQuery,
    glossQuery: glossQuery,
    descendantQuery: descendantQuery,
    propertyQuery: propertyQuery,
    unionQuery: unionQuery,
    iterativeAncestorQuery: iterativeAncestorQuery
}
