...
public class LemonBasedRDFDataHandler extends DbnaryModel implements IWiktionaryDataHandler {
	...
	public void addPartOfSpeech(String pos) {
	    PosAndType pat = posAndTypeValueMap.get(pos);
            //System.out.format("current pos resource= %s\n", posResource(pat));
	...
	public boolean registerEtymology(Map<String, String> args1, Map<String, String> args2, int type){ 
		...
		return false;
            ...
            if (type == 0 || type == 1){
                if (!(args1.get("lang").equals(currentEntryLanguageCode))){  
		...
		if (key.startsWith("word")){
		        ...
		        if (args2.get("lang")!=null && !(args2.get("lang").equals(currentEntryLanguageCode))){ 
